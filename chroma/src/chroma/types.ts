...
export type HarmonyMode =
  | 'analogous' | 'complementary' | 'split-comp' | 'triadic'
  | 'tetradic' | 'square' | 'monochromatic' | 'shades'
  | 'double-split' | 'compound' | 'natural' | 'random'
...
export interface ThemeTokenSet {
  ...
  utility: Record<UtilityRole, { base: string; light: string; dark: string; subtle: string }>
