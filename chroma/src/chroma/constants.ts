...
export const CB_TYPES: CBType[] = [
  ...
  { id: 'deuteranopia',  name: 'Deuteranopia',   desc: 'Green-blind · ~6% of males',
    matrix: [0.367,0.861,-0.228, 0.280,0.673,0.047, -0.012,0.043,0.969] },
  { id: 'protanopia',    name: 'Protanopia',     desc: 'Red-blind · ~2% of males',
    matrix: [0.152,1.053,-0.205, 0.115,0.786,0.099, -0.004,-0.048,1.052] },
  { id: 'tritanopia',    name: 'Tritanopia',     desc: 'Blue-yellow blind · ~0.01%',
    matrix: [1.256,-0.077,-0.179, -0.079,0.931,0.148, 0.005,0.691,0.304] },
  { id: 'achromatopsia', name: 'Achromatopsia',  desc: 'Complete color blindness · very rare',
    matrix: [0.299,0.587,0.114, 0.299,0.587,0.114, 0.299,0.587,0.114] },
  { id: 'deuteranomaly', name: 'Deuteranomaly',  desc: 'Reduced green sensitivity · ~5% of males',
    matrix: [0.531,0.566,-0.097, 0.176,0.764,0.060, -0.004,0.040,0.964] },
]
